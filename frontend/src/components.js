...
const siteData = {
  hero: {
    ...
    buildingImage: "https://i.ibb.co/ns56JcpF/thumb-show.jpg",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600">
                Наш центр располагается в современном многоэтажном здании, оснащенном 
                самым передовым медицинским оборудованием для диагностики и лечения 
              ...
              <ul className="space-y-3">
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">Современные операционные залы</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center">
                    <Check className="w-4 h-4 text-green-600" />
                  </div>
                  <span className="text-gray-700">Реанимационные отделения</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center">
                    <Check className="w-4 h-4 text-green-600" />
                  </div>
                  <span className="text-gray-700">Диагностическое оборудование</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center">
                    <Check className="w-4 h-4 text-green-600" />
                  </div>
                  <span className="text-gray-700">Комфортные палаты для пациентов</span>
                </li>
              </ul>
