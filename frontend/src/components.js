...
// Все остальные компоненты будут добавлены в следующем файле
export const AboutPage = () => <div>О центре - в разработке</div>;
export const DepartmentsPage = () => <div>Отделения - в разработке</div>;
export const DoctorsPage = () => <div>Врачи - в разработке</div>;
export const ServicesPage = () => <div>Услуги - в разработке</div>;
export const NewsPage = () => <div>Новости - в разработке</div>;
export const ContactPage = () => <div>Контакты - в разработке</div>;
export const AppointmentPage = () => <div>Запись на прием - в разработке</div>;
export const DoctorDashboard = () => <div>Кабинет врача - в разработке</div>;
export const AdminPanel = () => <div>Админ панель - в разработке</div>;