...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    ru: {
      ...
      // Appointment page
      appointmentPageDescription: 'Заполните форму для записи на консультацию к нашим специалистам',
      stepDoctorSelection: 'Выбор врача',
      stepDateTime: 'Дата и время',
      stepPersonalData: 'Личные данные',
      ...
      complaintPlaceholder: 'Опишите ваши жалобы',
      nextButton: 'Далее',
      backButton: 'Назад',
      submitButton: 'Отправить заявку',
      appointmentConfirmation: 'Заявка отправлена!',
      appointmentConfirmationText: 'Мы свяжемся с вами в ближайшее время для подтверждения записи.',
      newAppointmentButton: 'Новая запись',
      selectDoctor: 'Выберите врача',
    ...
    uz: {
      ...
      // Appointment page
      appointmentPageDescription: 'Mutaxassislarimizga konsultatsiya uchun formani to\'ldiring',
      stepDoctorSelection: 'Shifokor tanlash',
      stepDateTime: 'Sana va vaqt',
      stepPersonalData: 'Shaxsiy ma\'lumotlar',
      ...
      address: 'Manzil',
      complaint: 'Shikoyatlar va alomatlar',
      ...
      complaintPlaceholder: 'Shikoyatlaringizni tasvirlab bering',
      nextButton: 'Keyingi',
      backButton: 'Orqaga',
      submitButton: 'Arizani yuborish',
      appointmentConfirmation: 'Ariza yuborildi!',
      appointmentConfirmationText: 'Biz yaqin vaqt ichida siz bilan bog\'lanib, qabulni tasdiqlaymiz.',
      newAppointmentButton: 'Yangi yozuv',
      selectDoctor: 'Shifokorni tanlang',
      ...
      submissionError: 'Arizani yuborishda xatolik',
    ...
    en: {
      ...
      // Appointment page
      appointmentPageDescription: 'Fill out the form to schedule a consultation with our specialists',
      stepDoctorSelection: 'Doctor Selection',
      ...
      address: 'Address',
      complaint: 'Complaints and Symptoms',
      firstNamePlaceholder: 'Enter your first name',
      lastNamePlaceholder: 'Enter your last name',
      phonePlaceholder: 'Enter phone number',
      emailPlaceholder: 'Enter email address',
      addressPlaceholder: 'Enter your address',
      complaintPlaceholder: 'Describe your complaints',
      nextButton: 'Next',
      backButton: 'Back',
      submitButton: 'Submit Application',
      appointmentConfirmation: 'Application Sent!',
      appointmentConfirmationText: 'We will contact you shortly to confirm your appointment.',
